...
const tokenAddress = "0x350e655770e02e05B4f22169A7b8d3d5aAd6B46a"; // Mytoken Address
const ballotAddress = "0xf185087be41f7ae83690998f97c8c512b3a55f00"; // TokenizedBallot address
const proposalN = 0; //  proposal to vote for
...
async function main() {
    ...
    console.log(`Your proposal now has ${proposalVoteCount} votes`);
}
